...
void TonePlayer_PB6_TIM4::GPIO_Init()
{
...
void TonePlayer_PB6_TIM4::TIM_Init()
{
...
void TonePlayer_PB6_TIM4::playTone(uint32_t freq) {
...
void TonePlayer_PB6_TIM4::stopPlaying()
{
